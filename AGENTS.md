...
CloudForge is a production-grade DevOps laboratory: AWS simulated locally with **Floci**, Azure simulated locally with **Floci-AZ**, infrastructure managed with **OpenTofu**, changes validated through **GitHub Actions**, and **DevSecOps** practices enforced with **Trivy**.
...
| `rules/01-architecture.md` | Documentation updates, ADRs, AWS/Azure service justification |
...
| Skill | Use for |
| ----- | ------- |
| `skills/architecture/SKILL.md` | Adding/changing AWS or Azure services, ADRs |
| `skills/opentofu/SKILL.md` | Any change under `infrastructure/` |
| `skills/floci/SKILL.md` | Local AWS environment work |
| `skills/floci-az/SKILL.md` | Local Azure environment work |
...
* Local Azure endpoint: `http://localhost:4577`
* Unified cloud gateway: `http://localhost:4600` (50/50 AWS/Azure split)
