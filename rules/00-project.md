...
The project simulates AWS locally using **Floci**, manages infrastructure with **OpenTofu**, validates changes through **GitHub Actions**, and integrates **DevSecOps practices with Trivy**.
